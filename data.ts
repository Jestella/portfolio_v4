export const projects = [
  ...
  },
  {
    id: 2,
    title: 'Style S / 2021',
    sub: 'E-commerce platform built with React and Redux',
  ...
  {
    id: 3,
    title: 'bistro lee / 2022',
    sub: 'Restaurant website',
  ...
  {
    id: 4,
    title: 'S Multimedia Studio / 2021',
    sub: 'Built with 100% Vanilla JavaScript',
  ...
  },
  {
    id: 4,
    title: 'Quiz / 2021',
    sub: 'Get-to-Know-Her Quiz built with React',
  ...
  {
    id: 5,
    title: 'Star Wars for non Star Wars fans / 2021',
    sub: 'Star Wars Cheat Sheet',
  ...
  {
    id: 6,
    title: 'A Word A Day / 2021',
    sub: 'Dictionary app built with React',
    technologies: 'React',
    imageUrl:
  ...
  {
    id: 8,
    title: 'Blog, Story / 2020',
    sub: 'Blog website built using ejs',
